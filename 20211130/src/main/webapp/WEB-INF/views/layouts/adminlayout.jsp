...
<title><tiles:getAsString name="atitle"></tiles:getAsString></title>
...
<div id="app">
	...
	<tiles:insertAttribute name="abody"></tiles:insertAttribute>
	<tiles:insertAttribute name="afooter"></tiles:insertAttribute>
</div>
